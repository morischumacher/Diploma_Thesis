...
The three dimensions are operationalised through three sub-questions, which name what the evaluation measures:
...
RQ3a and RQ3b read efficiency from the path students take through the interface rather than from elapsed time; RQ3c reads effectiveness from an audit of the finished plans and satisfaction from self-report. This question is addressed by an evaluation study with students (Chapter~\ref{chap:evaluation}) and by the Discussion (Chapter~\ref{chap:discussion}).
