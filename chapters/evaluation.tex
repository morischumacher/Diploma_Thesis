...
\begin{itemize}
    ...
    \item \textbf{Components in the workflow:} Where does each of the tool's components sit in that process, and what does it contribute there? Answered for the surfaces that form the loop (Section~\ref{sec:eval-statemodel}) and for those that sit beside it (Section~\ref{sec:eval-around}).
