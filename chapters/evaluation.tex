...
Table~\ref{tab:problems} ranks the highest-impact and most frequent problems across the eleven participants. Most belong to a stage of the loop and were developed above; the last column marks the problems that have since been fixed. Those revisions were made after this study and are described in Chapter~\ref{chap:implementation} (Section~\ref{sec:impl-post-study}), so every problem the table lists was present in the system these participants used. What participants asked for in place of each problem is catalogued in Section~\ref{app:eval-unmet}, with the codes each request would resolve.
...
\begin{table}[htpb]
    ...
    \begin{tabular}{@{}l>{\raggedright\arraybackslash}p{7.0cm}ccl c@{}}
        ...
        E-P17 & Adding a semester not discoverable & 1 & 9/11 & effectiveness & \\
