...
Where plans missed their brief, they missed it on what the checklist does not model. Thirteen of the twenty-one resolved runs met every constraint; of the eight that did not, four plan no reduced-load semester at all, which is a requirement the tool has no way to express. The compliance layer certifies what it holds: its thresholds are supplied by the student rather than by the task, its lower bound only advises where its upper bound blocks, and the reduced-load semester lies outside its model altogether. All twenty-two runs nonetheless ended with the tool reporting no missing requirements, and seven runs their authors rated a success did not meet their brief. The instrument students trusted as their measure of completion was, for the constraints outside its model, silent rather than wrong.
