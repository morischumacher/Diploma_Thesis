...
\begin{table}[htpb]
    ...
    \begin{tabular}{clrr}
        ...
        \bottomrule
    \end{tabular}
    \caption{The post-task items and their means across the eleven analysed participants, numbered as in Table~\ref{tab:app-perscenario-instrument}. The three usefulness items are reported individually because they do not cohere as a scale. Item~5 is kept out of the ease-of-use mean because it correlated more strongly with usefulness than with the other ease-of-use items.}
    \label{tab:tam}
\end{table}
