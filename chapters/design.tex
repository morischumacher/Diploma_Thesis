...
\begin{tikzpicture}[font=\scriptsize, scale=0.85, transform shape]
  ...
  \node[font=\tiny,text=black!70,text width=2.1cm,align=center] at (1.0,-1.0) 
  {white fill, coloured border};
    ...
    \node[font=\tiny,text=black!70,text width=2.1cm,align=center] at (\ox+1.0,-1.0)
  ...
  \node[font=\tiny,text=black!70,text width=2.1cm,align=center] at (\ox+1.0,-1.0) {light grey fill, light grey border and text};
\end{tikzpicture}
...
\begin{tikzpicture}[font=\scriptsize,
  ...
  ann/.style={font=\tiny, anchor=west, text width=3.9cm, align=left},
  tick/.style={gray!55, thin}]
