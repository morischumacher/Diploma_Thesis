...
Overly dense text was reported as off-putting (T54). To support an always-current and legible planning view, students requested that key attributes like ECTS, obligation type, and completion status remain visible at a glance (T16). Furthermore, they explicitly requested that module completion status be visible directly on the canvas, rather than restricted solely to the Dashboard (T57; Feature~\ref{feat:002}, Req.~3). 
