...
\begin{enumerate}
  ...
  \item \textbf{Shortlist:} The student parks interesting courses into the \gterm{parking-stage}{Parking Stage} without needing to commit them to a specific semester.
