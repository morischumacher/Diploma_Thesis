...
All exclusions are recorded directly against their originating code in the codebook, with the specific out-of-scope boundary noted at the point of exclusion. %% REV (open: one exclusion in the appendix codebook, T53, is recorded as \enquote{No mobile app}, which is not one of OOS1--OOS5. Settled together with the codebook-appendix MR.)
...
The analysis produced 435 initial codes across the six interviews, consolidated into 64 themes labelled T1--T64. The scope-based review of Step~3 carried 51 of these forward, ruled 11 out of scope, and set 2 aside as procedural artefacts of the interview situation itself. The complete codebook, giving each theme's label, the number of interviews in which it recurred, whether it was carried forward or excluded together with the boundary that excluded it, and the feature it maps to in Chapter~\ref{chap:from-themes-to-requirements}, is reproduced in Appendix~\ref{app:codebook}.
