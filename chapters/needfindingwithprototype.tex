...
The analysis produced 435 initial codes across the six interviews, consolidated into 64 themes labelled T1--T64. The scope-based review of Step~3 carried 51 of these forward, ruled 11 out of scope, and set 2 aside as procedural artefacts of the interview situation itself. The complete codebook is reproduced in Appendix~\ref{app:codebook}: every theme with its label, the number of interviews it recurred in, the disposition the review gave it, and all 437 excerpts that informed it, each in translation beside the German original. The table of initial codes behind it is not reproduced, since each code labels a single excerpt and the excerpts are given in full.
