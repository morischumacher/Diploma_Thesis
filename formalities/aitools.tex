...
All outputs were reviewed critically and, where appropriate, revised. My
creative influence predominates in the final work. The design decisions, the
interpretation of the evidence, and the conclusions drawn are my own. AI tools used:
...
\begin{itemize}
  ...
  \item Gemini\footnote{\url{https://gemini.google.com}}, Google. Models: Gemini~2.5~Pro,
        Gemini~3~Pro and Gemini~3.1~Pro, versions as of October~2025 --
        September~2026. Writing aid.
