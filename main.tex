...
\usepackage{placeins} % \FloatBarrier, to keep a table in the section that introduces it.
...
\PassOptionsToPackage{hyphens}{url} % Let long URLs break at hyphens; without this the
                                    % bibliography's blog URL overruns the right margin.
