...
%% AIREV [MINOR] (The word this thesis most needs to pin down, "dependency", has no glossary entry, and the text uses it in two senses: the containment relation the graph draws, and the prerequisite relation of the cited literature and of Chapter 8's "dependency information". An entry stating both senses and which one a bare "dependency" means would defuse the ambiguity flagged at Research Question 1.)
\end{description}
