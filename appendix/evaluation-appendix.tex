...
% -----------------------------------------------------------------------------
\TDminor{Dependency sweep, this appendix: 3 occurrences, one must not be touched}{Questionnaire item~2, \enquote{The interface improved my productivity when dealing with course dependencies and constraints}, is the instrument as it was administered and is reproduced verbatim; it is outside the house vocabulary by necessity and must not be reworded. E-G08's definition already names both senses explicitly. E-N01 is a participant's own framing.}
